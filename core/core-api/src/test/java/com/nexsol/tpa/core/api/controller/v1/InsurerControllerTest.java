...
public class InsurerControllerTest extends RestDocsTest {
    ...
    void getInsurers() throws Exception {
        // Given
        List<Insurer> mockInsurers = List.of(
                new Insurer(1L, "MERITZ", "메리츠화재"),
                new Insurer(2L, "SAMSUNG", "삼성화재"),
        ...
        // When & Then
        mockMvc.perform(get("/v1/admin/travel/insurer")
                ...
                .andDo(document("insurer-list",
                        responseFields(
                                ...
                                fieldWithPath("data[].code").description("보험사 코드"),
                                fieldWithPath("data[].name").description("보험사명")
                        )
                ));
    }
