...
public class PlanControllerTest extends RestDocsTest {
	...
	void getPlans() throws Exception {
		// Given
		List<Plan> mockPlans = List.of(new Plan(1L, "PLAN001", "알뜰 플랜", "해외여행자보험", "알뜰플랜(15~69세)", 2L, true, 1L),
				new Plan(2L, "PLAN002", "표준 플랜", "해외여행자보험", "표준플랜(15~69세)", 2L, true, 1L),
				new Plan(3L, "PLAN003", "프리미엄 플랜", "해외여행자보험", "프리미엄플랜(15~69세)", 2L, true, 1L));
	...
	void getPlansByInsurerId() throws Exception {
		// Given
		Long insurerId = 1L;
		List<Plan> mockPlans = List.of(new Plan(1L, "PLAN001", "알뜰 플랜", "해외여행자보험", "알뜰플랜(15~69세)", 2L, true, insurerId),
				new Plan(2L, "PLAN002", "표준 플랜", "해외여행자보험", "표준플랜(15~69세)", 2L, true, insurerId));
