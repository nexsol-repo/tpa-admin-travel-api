...
public class TravelEmailSender {

    private final JavaMailSender javaMailSender;

    public void send(String toEmail, NotificationType type, String link, String name) {
        try {
            MimeMessage message = javaMailSender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");

            helper.setTo(toEmail);
            helper.setSubject(type.getEmailTitle());

            String html = getHtmlTemplate(type, link, name);
            helper.setText(html, true);

            javaMailSender.send(message);
            log.info("해외여행보험 메일발송 성공: {}", toEmail);
        }
        catch (Exception e) {
    ...
    private String getHtmlTemplate(NotificationType type, String link, String name) {
        String title = type == NotificationType.REJOIN ? "보험료 안내" : "가입확인서 안내";
        ...
        return """
                        ...
                        <tr>
                          <td colspan="2" style="padding: 30px 0; border-bottom: 1px solid #e7e9eb;">
                            ...
                            <p style="margin: 20px 0 0 0; font-size: 15px; line-height: 1.6; color: #555; letter-spacing: -0.5px;">
                              ...
                              TPA KOREA 해외여행보험 고객센터(<strong>1644-9664</strong>)로 문의해 주시기 바랍니다.<br />
                              좋은 하루 되시길 바랍니다.<br />
                              감사합니다.
                            </p>
                          </td>
                            ...
                            <table role="presentation" style="width: 100%%; border-collapse: collapse;">
                              ...
                              <tr>
                                ...
                                <td style="padding: 4px 0; font-size: 15px; color: #333;">
                                  : <a href="https://travel.tpakorea.com/" target="_blank" style="color: #00B855; text-decoration: underline;">공식 홈페이지 바로가기</a>
                                </td>
                              </tr>
                              </tbody>
                            </table>
                ...
                """
            .formatted(title, name, type.getTargetName(), link, type.getLinkText());
    }
